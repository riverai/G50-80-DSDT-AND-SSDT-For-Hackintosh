 ...
 *
 * Disassembly of DSDT.aml, Sun Nov  8 22:08:01 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010066 (65638)
 *     Revision         0x02
 *     Checksum         0x5A
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    OperationRegion (LFCN, SystemMemory, 0x9CDDAD98, 0x00E9)
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0x9CF7CC18, 0x0383)
            ...
            Scope (\_SB.PCI0.LPCB.EC0)
            {
                Device (VPC0)
                {
                    ...
                    Method (SMTF, 1, NotSerialized)
                    {
                        If (LEqual (Arg0, Zero))
                        {
                            If (LEqual (B1B2(CB00,CB01), Zero))
                            {
                                Return (Zero)
                            }

                            If (LEqual (B1B2(CG00,CG01), Zero))
                            {
                                Return (Zero)
                            }
                            ...
                            Multiply (Local0, 0x0A, Local0)
                            Store (Local0, VBFC)
                            Store (B1B2(CA00,CA01), Local1)
                            Multiply (Local1, 0x0A, Local1)
                            Store (Local1, VBRC)
                            If (LGreater (VBFC, VBRC))
                            {
                                Store (B1B2(CB00,CB01), VBPV)
                                Store (B1B2(CG00,CG01), VBAC)
...
P8XH (One, 0xAB)
    ...
    OperationRegion (LGNS, SystemMemory, 0x9CF5A000, 0x00000005)
